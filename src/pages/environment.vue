	...
	<el-row>
		<el-col :span="7">
			...
			<div class="chart" :style="{height:((height-80)/3 - 10)+'px'}">
				<div class="itemtitle" style="">行政区邮件阈值</div>
			...
			<div class="chart" :style="{height:((height-80)/3 - 20)+'px'}">
				<div class="itemtitle" style="">月度邮件量走势</div>
		...
		<el-col :span="10">
			...
			<div class="chart" :style="{height:(height-80 - 20)+'px'}">
				<div class="itemtitle" style="">行政区邮件数量(天)</div>
				<div>
					<div class="flex">
						<div class="flex_item">
							<!-- 土壤温度 -->
		...
		<el-col :span="7">
			<!-- PH值 -->
			<div class="chart" :style="{height:((height-80)/3 - 20)+'px'}">
				<div class="itemtitle" style="">邮政员工业绩增长率</div>

				<v-chart ref="phchart" :style="{height:(((height-80)/3 - 40 - 15)+'px')}" :option="phchart" />
			</div>
			<!-- 土壤盐度 -->
			<div class="chart" :style="{height:((height-80)/3 - 20)+'px'}">
				<div class="itemtitle" style="">邮政员工业绩离职率</div>
			...
			<div class="chart" :style="{height:((height-80)/3 - 10)+'px'}" style="padding:0px">
				<div class="itemtitle" style="">该地区邮政员工离职数量</div>
	...
	export default {
		...
		methods: {
			...
			inittempchart: function() {
				return {
					backgroundColor: '#000000',
					title: utils.createChartTitle('地区邮件量'),
			...
			initshiduchart: function() {
				return {
					backgroundColor: '#000000',
					title: utils.createChartTitle('地区邮件变化量'),
					grid: utils.createChartGaid(null, '20px', "50px", "40px"),
					tooltip: {
						trigger: 'axis',
						axisPointer: {
			...
			initligtechart: function() {
				...
				return {
					backgroundColor: '#000000',
					title: utils.createChartTitle('邮件阈值'),
					grid: utils.createChartGaid(null, '20px', "50px", "40px"),
					tooltip: {
						trigger: 'axis',
						axisPointer: {
			...
			initlinchart: function() {
				return {
					backgroundColor: '#000000',
					title: utils.createChartTitle('邮局员工增长量'),
					grid: utils.createChartGaid(null, '20px', "50px", "40px"),
					tooltip: {
						trigger: 'axis',
						axisPointer: {
			...
			initdanchart: function() {
				return {
					backgroundColor: '#000000',
					title: utils.createChartTitle('航空邮件量'),
					grid: utils.createChartGaid(null, '20px', "50px", "40px"),
					tooltip: {
						trigger: 'axis',
						axisPointer: {
			...
			initjiachart: function() {
				return {
					backgroundColor: '#000000',
					title: utils.createChartTitle('航空邮件增长量'),
					grid: utils.createChartGaid(null, '20px', "50px", "40px"),
					tooltip: {
						trigger: 'axis',
						axisPointer: {
