	...
	<el-row>
		<el-col :span="6">
					...
					<el-col :span="8">
						<div class="flex">
							...
							<div class="flex_item" style="text-align: center;">
								...
								<div style="line-height: 40px;color: #fff;font-size: 16px;">
									<span style="margin-left: 5px;">该地区邮政局数量</span>
								</div>
							</div>
						</div>
					</el-col>
					<el-col :span="8">
						<div class="flex">
							...
							<div class="flex_item" style="text-align: center;">
								...
								<div style="line-height: 40px;color: #fff;font-size: 16px;">
									<span style="margin-left: 5px;">邮政运行中车辆</span>
								</div>
							</div>
						</div>
					</el-col>
					...
					<el-col :span="8">
						<div class="flex">
							...
							<div class="flex_item" style="text-align: center;">
								...
								<div style="line-height: 40px;color: #fff;font-size: 16px;">
									<span style="margin-left: 5px;">行政区告警量</span>
								</div>
							</div>
						</div>
					</el-col>
			...
			<div class="chart" :style="{height:((height-80)/3 - 10)+'px'}">
				<div class="itemtitle" style="">城市交通实时监控</div>
		...
		data(){
			 return{
				...
				videos:[{
					id:1,
					name:'摄像001',
					url:'/src/assets/city1.webp',
					status:'1'
				},{
					id:2,
					name:'摄像002',
					url:'/src/assets/laozai1.webp',
					status:'2'
				},{
					id:3,
					name:'摄像003',
					url:'/src/assets/city3.webp',
					status:'1'
				},{
					id:4,
					name:'摄像004',
					url:'/src/assets/city2.webp',
					status:'1'
				}],
