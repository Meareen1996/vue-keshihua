		...
		<div v-if="!welcome" class="container" :class="curTheme">
			<el-row class="title">
				...
				<el-col :span="8" style="position: relative;">
					...
					<div class="header">中国邮政行业运行数据可视化系统</div>
					<div
				...
				<el-col :span="8">
					<div class="flex menus_div">
						<div class="menus flex_item flex">
							<div class="flex_item">
								<div class="menu_item" @click="turnPage('/index')">综合数据</div>
							</div>
							<div class="flex_item">
								<div class="menu_item" @click="turnPage('/crop')">实时数据</div>
							</div>
							<div class="flex_item">
								<div class="menu_item" @click="turnPage('/environment')">职工看表</div>
							</div>
							<div class="flex_item">
								<div class="menu_item" @click="turnPage('/market')">线上监控</div>
							</div>
							<div class="flex_item">
